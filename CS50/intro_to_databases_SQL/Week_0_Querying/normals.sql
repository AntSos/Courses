...
SELECT  "0m", "100m", "200m"
FROM "normals"
WHERE "latitude" = 96.4 AND "longitude" = 19.1;
...
ORDER BY "0m" DESC
LIMIT 1;
-- In 6.sql, write a SQL query to return all normal ocean temperatures at 50m of depth, as well as their respective degrees of latitude and longitude,
-- within the Arabian Sea. Include latitude, longitude, and temperature columns. For simplicity, assume the Arabian Sea is encased in the following four coordinates:
